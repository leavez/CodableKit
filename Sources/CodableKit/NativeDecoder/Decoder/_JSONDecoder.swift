...
internal class _JSONDecoder : Decoder {
    ...
    internal var storage: _JSONDecodingStorage
    
    /// Options set on the top-level decoder.
    internal let options: MagicJSONDecoder._Options
    ...
    internal init(referencing container: Any, at codingPath: [CodingKey] = [], options: MagicJSONDecoder._Options) {
