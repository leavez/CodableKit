//
//  _JSONKeyedDecodingContainer.swift
//  CodableKit
//
//
...
internal struct _JSONKeyedDecodingContainer<K : CodingKey> : KeyedDecodingContainerProtocol {
    typealias Key = K
    ...
    internal init(referencing decoder: _JSONDecoder, wrapping container: [String : Any]) {
