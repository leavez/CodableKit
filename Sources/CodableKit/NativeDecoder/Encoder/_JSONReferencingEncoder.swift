...
internal class _JSONReferencingEncoder : _JSONEncoder {
    ...
    internal let encoder: _JSONEncoder
    ...
    internal init(referencing encoder: _JSONEncoder, at index: Int, wrapping array: NSMutableArray) {
    ...
    internal init(referencing encoder: _JSONEncoder,
