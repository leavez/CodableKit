//
//  _JSONUnkeyedEncodingContainer.swift
//  CodableKit
//
//
...
internal struct _JSONUnkeyedEncodingContainer : UnkeyedEncodingContainer {
    // MARK: Properties
    ...
    internal init(referencing encoder: _JSONEncoder, codingPath: [CodingKey], wrapping container: NSMutableArray) {
