...
internal class _JSONEncoder : Encoder {
    ...
    internal var storage: _JSONEncodingStorage
    
    /// Options set on the top-level encoder.
    internal let options: MagicJSONEncoder._Options
    ...
    internal init(options: MagicJSONEncoder._Options, codingPath: [CodingKey] = []) {
