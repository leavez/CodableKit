...
struct _KeyedDecodingContainer<Key: CodingKey>: KeyedDecodingContainerProtocol {
    ...
    func nestedContainer<NestedKey: CodingKey>(
        ...
        case .object(let object):
            return KeyedDecodingContainer(_KeyedDecodingContainer<NestedKey>(codingPath: codingPath + [key],
                                                                             decoder: decoder,
                                                                             object: object))
        default:
            fatalError()
    ...
    func nestedUnkeyedContainer(forKey key: Key) throws -> UnkeyedDecodingContainer {
        ...
        case .array(let array):
            return _UnkeyedDecodingContainer(codingPath: codingPath + [key], decoder: decoder, array: array)
        default:
            fatalError()
        }
    }
